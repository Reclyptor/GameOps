...
# The password the server is enforcing, and the address players can actually
# use, as the server wrote them at boot.
game_join_password() { cat "${DATA_DIR}/join-password"; }
game_server_address() { cat "${DATA_DIR}/announce-address"; }
